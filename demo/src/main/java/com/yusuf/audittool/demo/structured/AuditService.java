...
public class AuditService {
    ...
    public NormalizeResponse normalize(AnalyzeRequest request) {
        return new NormalizeResponse(normalizeService.normalize(toAuditInput(request)));
    }

    public AnalyzeResponse analyze(AnalyzeRequest request) {
        AgentContext context = normalizeService.normalize(toAuditInput(request));
    ...
    private AuditInput toAuditInput(AnalyzeRequest request) {
        if (request == null) {
            return null;
        }
