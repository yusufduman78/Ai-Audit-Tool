...
| [OpenCode Denetim Ajanı Kullanım Rehberi](../integration/opencode_agent_kullanimi.md) | `/audit` komutu, adapter ve kısıtlı ajan akışı | Sistemi OpenCode ajanı olarak kullanırken |
