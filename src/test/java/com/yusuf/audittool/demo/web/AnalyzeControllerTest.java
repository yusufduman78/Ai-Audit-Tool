...
import com.yusuf.audittool.demo.model.AvailableModel;
import com.yusuf.audittool.demo.model.ModelCatalogResponse;
import com.yusuf.audittool.demo.ollama.AgentClient;
...
class AnalyzeControllerTest {
    ...
    @Test
    void rootRedirectsToDemoPage() throws Exception {
        mockMvc.perform(get("/"))
    ...
    @Test
    void demoPageIsServedFromItsOwnResourceFolder() throws Exception {
        mockMvc.perform(get("/demo/index.html"))
                .andExpect(status().isOk())
                .andExpect(content().string(org.hamcrest.Matchers.containsString("AI Audit Tool")));
    }

    @Test
    void healthReturnsOk() throws Exception {
        mockMvc.perform(get("/demo/api/health"))
                .andExpect(status().isOk())
    ...
    void modelsReturnsInstalledOllamaModels() throws Exception {
        ...
        mockMvc.perform(get("/demo/api/models"))
                .andExpect(status().isOk())
    ...
    void normalizeReturnsAgentContext() throws Exception {
        mockMvc.perform(post("/demo/api/normalize")
    ...
    void analyzeBuildsPromptAndReturnsAgentOutput() throws Exception {
        ...
        mockMvc.perform(post("/demo/api/analyze")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
                                  "payload": {
